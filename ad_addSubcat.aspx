<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ad_addSubcat.aspx.cs" Inherits="IWin.UI.ad_addstore" %>
            ...
            <div class="adminform">
                  <div class="row">
                        <div class="col-sm-3" style="left: 27px; top: 1px; width: 742px;">
                               <asp:Label ID="lblSName" runat="server" Text="Subcategory name"></asp:Label><br /><br />
                               <br /><br />
                         </div>
                        <div class="col-sm-3">
                                <br />
