...
namespace IWinBLL
{
    public class blUtil
    {
        ...
        public static bool Verifypassword(string enteredPassword, string dbHash, string dbSalt)
        {
            var saltBytes = Convert.FromBase64String(dbSalt);
            var rfc2898DeriveBytes = new Rfc2898DeriveBytes(enteredPassword, saltBytes, 10000);
            return Convert.ToBase64String(rfc2898DeriveBytes.GetBytes(256)) == dbHash;
        }
    }
}
