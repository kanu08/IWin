<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ad_updCat.aspx.cs" Inherits="IWin.mainProdview" %>
...
<%--    <div class="container" style="margin-top:110px;margin-left:380px">--%>
       ...
       <asp:TextBox ID="txtSearch" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox><br />
        <br /><br />
     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="category_Id" OnRowCancelingEdit="GridView2_RowCancelingEdit" 
...
<%--                    <asp:BoundField DataField="category_id" HeaderText="category_ID" />  --%>                      
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse"><tr>
            <td style="width: 107px"><asp:Label runat="server" Text="Category Name:" ForeColor="White"></asp:Label></td>
             <td style="width: 100px">              
                <asp:TextBox ID="txtCategory" runat="server" Width="140" />
            </td>
            <td style="width: 58px">
