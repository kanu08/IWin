<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="us_bbfProd.aspx.cs" Inherits="IWin.us_bbfProd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:GridView ID="grdproductDetails" runat="server" DataKeyNames="product_id"
        AutoGenerateColumns="False"
        onpageindexchanging="grdproductDetails_PageIndexChanging"
 AllowPaging="True" PageSize="5"
        CellPadding="4" ForeColor="#333333" GridLines="None">  <%--     onrowediting="grdproductDetails_RowEditing"
        onrowupdating="grdproductDetails_RowUpdating"--%> 
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
    <Columns>
    <asp:TemplateField HeaderText="Product Name">
    <ItemTemplate>
        <asp:Label ID="lblid" runat="server" Text='<%#Eval("product_id")%>'></asp:Label>
    </ItemTemplate>
    <ItemTemplate>
        <asp:Label ID="lblProductName" runat="server" Text='<%#Eval("Name")%>'></asp:Label>
    </ItemTemplate>
    <EditItemTemplate>
        <asp:TextBox ID="txtProductNameEdit" runat="server" Text='<%#Eval("Name")%>'></asp:TextBox></EditItemTemplate>
    </asp:TemplateField>
